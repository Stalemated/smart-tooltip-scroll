package com.stalemated.rst.gui.screen;
...
public class TooltipDimensionsScreen {
    ...
    public static Screen create(Screen parent) {
        RSTConfig config = ConfigManager.getConfig();
    ...
    private static OptionGroup createCustomDimensionsGroup(RSTConfig config) {
    ...
    private static OptionGroup createScrollingGroup(RSTConfig config) {
